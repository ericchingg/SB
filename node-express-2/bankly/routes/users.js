 ...
 *
 */
    // FIXES BUG #4 - removed requireAdmin from middleware. added allowedfields to update.
    // added error handler for missing user.
  ...
  try {
    ...
    for (let field in fields) {
      if (!allowedFields.includes(field)) {
        throw new ExpressError(`Field '${field}' is not allowed to be changed.`, 401);
      }
    }
