...
<head>
  ...
  <meta name="nodejs.org:node-version" content="v21.7.1">
  <title>Console | Node.js v21.7.1 Documentation</title>
    ...
    <div id="column1" data-id="console" class="interior">
      <header class="header">
        <div class="header-container">
          <h1>Node.js v21.7.1 documentation</h1>
        ...
        <div id="gtoc">
          <ul>
            <li class="pinned-header">Node.js v21.7.1</li>
...
<li><a href="https://github.com/nodejs/node" class="nav-https-github-com-nodejs-node">Code repository and issue tracker</a></li>
    ...
    <li class="picker-header">
      ...
      <div class="picker"><ol id="alt-docs"><li><a href="https://nodejs.org/docs/latest-v21.x/api/console.html">21.x</a></li>
...
<p><strong>Source Code:</strong> <a href="https://github.com/nodejs/node/blob/v21.7.1/lib/console.js">lib/console.js</a></p>
